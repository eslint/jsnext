/**
 * @fileoverview Differential test for `analyze()`: the Rust scope buffer must
 * be byte-identical to the TypeScript one for every file.
 *
 * Usage: node tools/diff-analyze.mjs <dir-or-file> [limit]
...
const { parse, analyze } = await import(
