 ...
 * is a little-endian 32-bit word, the same convention `@eslint/jsparse`'s AST
 * buffer and `@eslint/jsscope`'s scope buffer use, and every consumer reads
 * it through the constants below rather than through magic numbers of its
 * own.
 *
...
export const H_GRAPH_COUNT = 3;
export const H_BLOCK_COUNT = 4;
export const H_EDGE_COUNT = 5;
export const H_WRITE_COUNT = 6;
export const H_GRAPHS_BASE = 7;
export const H_BLOCKS_BASE = 8;
export const H_EDGES_BASE = 9;
export const H_PREDS_BASE = 10;
export const H_WRITES_BASE = 11;
export const H_POOL_BASE = 12;
export const H_NODE_BLOCK_BASE = 13;
export const H_NODE_BLOCK_COUNT = 14;
export const H_RESERVED = 15;
