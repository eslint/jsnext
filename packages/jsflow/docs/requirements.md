# Requirements for jsflow

## Goal

Create a utility that evaluates the binary AST format from `jsparse` and the binary format from `jsscope` into a control flow graph.
