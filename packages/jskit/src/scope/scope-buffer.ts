 ...
 * format. Everything in it is a little-endian 32-bit word, the same
 * convention the parser's parse buffer uses, and every consumer — `Scopes`,
...
export const SCOPE_H_MAGIC = 0;
export const SCOPE_H_VERSION = 1;
export const SCOPE_H_FLAGS = 2;
export const SCOPE_H_SCOPE_COUNT = 3;
export const SCOPE_H_SYMBOL_COUNT = 4;
export const SCOPE_H_REFERENCE_COUNT = 5;
export const SCOPE_H_DEFINITION_COUNT = 6;
export const SCOPE_H_SCOPES_BASE = 7;
export const SCOPE_H_SYMBOLS_BASE = 8;
export const SCOPE_H_REFERENCES_BASE = 9;
export const SCOPE_H_DEFINITIONS_BASE = 10;
export const SCOPE_H_POOL_BASE = 11;
export const SCOPE_H_NODE_SCOPE_BASE = 12;
export const SCOPE_H_NODE_SCOPE_COUNT = 13;
export const SCOPE_H_DECLARED_BASE = 14;
export const SCOPE_H_DECLARED_COUNT = 15;
export const SCOPE_H_IDENT_REF_BASE = 16;
export const SCOPE_H_IDENT_REF_COUNT = 17;
export const SCOPE_H_STRINGS_BASE = 18;
export const SCOPE_H_STRING_COUNT = 19;
export const SCOPE_H_STRING_BYTES = 20;
export const SCOPE_H_OPTIONS = 21;
export const SCOPE_H_JSX_PRAGMA = 22;
export const SCOPE_H_JSX_FRAGMENT = 23;

/** How many words the header occupies. */
export const SCOPE_HEADER_WORDS = 24;

/** `SCOPE_H_FLAGS` bit: handles are tree enumeration indexes, not byte offsets. */
export const BUFFER_TREE_HANDLES = 1;

/*
 * `SCOPE_H_OPTIONS` records the options the analysis ran with, so that a
 * consumer of the buffer does not have to be told them again. `globals` is not
 * among them: supplied globals are already materialized as symbols by the time
