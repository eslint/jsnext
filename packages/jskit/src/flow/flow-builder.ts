...
export class FlowBuilder {
	...
	finish(): ArrayBuffer {
		...
		out[FLOW_H_FLAGS] = 0;
		out[FLOW_H_GRAPH_COUNT] = graphCount;
		out[FLOW_H_BLOCK_COUNT] = blockCount;
		out[FLOW_H_EDGE_COUNT] = edgeCount;
		out[FLOW_H_WRITE_COUNT] = writeCount;
		out[FLOW_H_GRAPHS_BASE] = graphsBase;
		out[FLOW_H_BLOCKS_BASE] = blocksBase;
		out[FLOW_H_EDGES_BASE] = edgesBase;
		out[FLOW_H_PREDS_BASE] = predsBase;
		out[FLOW_H_WRITES_BASE] = writesBase;
		out[FLOW_H_POOL_BASE] = poolBase;
		out[FLOW_H_NODE_BLOCK_BASE] = nodeBlockBase;
		out[FLOW_H_NODE_BLOCK_COUNT] = pairCount;
