...
- **Most of ECMAScript's early errors.** Around 49 test262 files are invalid
  programs that both phases accept: a numeric separator against a leading
  zero, `a ?? b || c` without parentheses, `-a ** b`.
