...
- **Most of ECMAScript's early errors.** Around 37 test262 files are invalid
  programs that both phases accept: `a ?? b || c` without parentheses,
  `-a ** b`, `new.target` outside a function.
